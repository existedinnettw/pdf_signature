...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1337: (x0,x1) => x0.appendChild(x1),
      _1338: x0 => ({type: x0}),
      _1339: (x0,x1) => new Blob(x0,x1),
      _1340: x0 => globalThis.URL.createObjectURL(x0),
      _1342: (x0,x1,x2,x3) => x0.sendCommand(x1,x2,x3),
      _1343: () => globalThis.PdfiumWasmCommunicator,
      _1345: x0 => { globalThis.pdfiumWasmWorkerUrl = x0 },
      _1346: (x0,x1) => x0.writeText(x1),
      _1347: x0 => x0.preventDefault(),
      _1348: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1348(f,arguments.length,x0) }),
      _1349: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _1350: x0 => x0.createRange(),
      _1351: (x0,x1) => x0.selectNode(x1),
      _1352: x0 => x0.getSelection(),
      _1353: x0 => x0.removeAllRanges(),
      _1354: (x0,x1) => x0.addRange(x1),
      _1355: (x0,x1) => x0.createElement(x1),
      _1356: (x0,x1) => x0.append(x1),
      _1357: (x0,x1,x2) => x0.insertRule(x1,x2),
      _1358: (x0,x1) => x0.add(x1),
      _1359: x0 => x0.preventDefault(),
      ...
      _1449: s => JSON.stringify(s),
      _1450: s => printToConsole(s),
      _1451: (o, p, r) => o.replaceAll(p, () => r),
      _1453: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1454: s => s.toUpperCase(),
      _1455: s => s.trim(),
      _1456: s => s.trimLeft(),
      _1457: s => s.trimRight(),
      _1458: (string, times) => string.repeat(times),
      _1459: Function.prototype.call.bind(String.prototype.indexOf),
      _1460: (s, p, i) => s.lastIndexOf(p, i),
      _1461: (string, token) => string.split(token),
      _1462: Object.is,
      _1463: o => o instanceof Array,
      _1464: (a, i) => a.push(i),
      _1467: (a, l) => a.length = l,
      _1468: a => a.pop(),
      _1469: (a, i) => a.splice(i, 1),
      _1470: (a, s) => a.join(s),
      _1471: (a, s, e) => a.slice(s, e),
      _1474: a => a.length,
      ...
      _1480: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1482: o => o instanceof Uint8Array,
      _1483: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1484: o => o instanceof Int8Array,
      _1485: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1486: o => o instanceof Uint8ClampedArray,
      _1487: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1488: o => o instanceof Uint16Array,
      _1489: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1490: o => o instanceof Int16Array,
      _1491: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1492: o => o instanceof Uint32Array,
      _1493: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1494: o => o instanceof Int32Array,
      _1495: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1497: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1498: o => o instanceof Float32Array,
      _1499: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1500: o => o instanceof Float64Array,
      _1501: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1502: (t, s) => t.set(s),
      _1503: l => new DataView(new ArrayBuffer(l)),
      _1504: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1505: o => o.byteLength,
      _1506: o => o.buffer,
      _1507: o => o.byteOffset,
      _1508: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1509: (b, o) => new DataView(b, o),
      _1510: (b, o, l) => new DataView(b, o, l),
      _1511: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1512: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1513: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1514: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1515: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1516: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1517: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1518: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1519: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1520: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1521: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1522: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1525: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1526: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1527: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1528: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1529: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1530: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1543: (ms, c) =>
      ...
      _1582: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1582(f,arguments.length,x0,x1) }),
      _1583: o => {
      ...
      _1637: (x0,x1) => x0.key(x1),
      _1638: x0 => x0.random(),
      _1639: (x0,x1) => x0.getRandomValues(x1),
      _1640: () => globalThis.crypto,
      ...
      _1668: () => globalThis.document,
      _1669: () => globalThis.window,
      _1674: (x0,x1) => { x0.height = x1 },
      _1676: (x0,x1) => { x0.width = x1 },
      _1679: x0 => x0.head,
      _1680: x0 => x0.classList,
      _1684: (x0,x1) => { x0.innerText = x1 },
      _1685: x0 => x0.style,
      _1687: x0 => x0.sheet,
      _1698: x0 => x0.offsetX,
      _1699: x0 => x0.offsetY,
      _1700: x0 => x0.button,
      _1759: (x0,x1) => { x0.responseType = x1 },
      _1760: x0 => x0.response,
      _1820: (x0,x1) => { x0.draggable = x1 },
      _1836: x0 => x0.style,
      _2089: x0 => x0.content,
      _2195: (x0,x1) => { x0.download = x1 },
      _2220: (x0,x1) => { x0.href = x1 },
      _2765: (x0,x1) => { x0.accept = x1 },
      _2779: x0 => x0.files,
      _2805: (x0,x1) => { x0.multiple = x1 },
      _2823: (x0,x1) => { x0.type = x1 },
      _3073: (x0,x1) => { x0.src = x1 },
      _3075: (x0,x1) => { x0.type = x1 },
      _3079: (x0,x1) => { x0.async = x1 },
      _3093: (x0,x1) => { x0.charset = x1 },
      _3524: x0 => x0.items,
      _3527: (x0,x1) => x0[x1],
      _3531: x0 => x0.length,
      _3537: x0 => x0.dataTransfer,
      _3541: () => globalThis.window,
      _3584: x0 => x0.location,
      _3603: x0 => x0.navigator,
      _3674: (x0,x1) => { x0.ondragenter = x1 },
      _3676: (x0,x1) => { x0.ondragleave = x1 },
      _3678: (x0,x1) => { x0.ondragover = x1 },
      _3682: (x0,x1) => { x0.ondrop = x1 },
      _3867: x0 => x0.localStorage,
      _3875: x0 => x0.href,
      _3969: x0 => x0.clipboard,
      _3990: x0 => x0.userAgent,
      _3991: x0 => x0.vendor,
      _4198: x0 => x0.length,
      _6102: x0 => x0.type,
      _6204: x0 => x0.firstChild,
      _6215: () => globalThis.document,
      _6297: x0 => x0.body,
      _6629: (x0,x1) => { x0.id = x1 },
      _6656: x0 => x0.children,
      _6962: x0 => x0.clientX,
      _6963: x0 => x0.clientY,
      _8157: x0 => x0.size,
      _8158: x0 => x0.type,
      ...
      _8170: x0 => x0.length,
      _8175: x0 => x0.result,
      _11083: (x0,x1) => { x0.display = x1 },
      _12990: x0 => x0.isDirectory,
      _12991: x0 => x0.name,
      _12992: x0 => x0.fullPath,
